  ...
  },
  {
    ...
    children: [
      ...
      { textKey: 'nav.adminAccidentReport', icon: <ReportIcon />, path: '/admin/accident-report' },
      {
        ...
        icon: <AssessmentIcon />,
        children: [
          { textKey: 'nav.landBudget', icon: <AssessmentIcon />, path: '/admin/land-budget' },
          { textKey: 'nav.seaBudget', icon: <DirectionsBoatIcon />, path: '/admin/sea-budget' },
          { textKey: 'nav.landCrewStats', icon: <WorkIcon />, path: '/admin/land-crew-stats' },
